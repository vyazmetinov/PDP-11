...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.isAssembler = QAction(MainWindow)
        self.isAssembler.setObjectName(u"isAssembler")
        self.isAssembler.setCheckable(True)
        self.isAssembler.setChecked(True)
        self.isRegisters = QAction(MainWindow)
        self.isRegisters.setObjectName(u"isRegisters")
        self.isRegisters.setCheckable(True)
        self.isRegisters.setChecked(True)
        self.isCode = QAction(MainWindow)
        self.isCode.setObjectName(u"isCode")
        self.isCode.setCheckable(True)
        self.isCode.setChecked(True)
        self.actionStop = QAction(MainWindow)
        self.actionStop.setObjectName(u"actionStop")
        self.actionStep = QAction(MainWindow)
        self.actionStep.setObjectName(u"actionStep")
        self.isMemory = QAction(MainWindow)
        self.isMemory.setObjectName(u"isMemory")
        self.isMemory.setCheckable(True)
        self.isMemory.setChecked(True)
        ...
        self.Visibility = QMenu(self.menubar)
...
"}")
        ...
        self.registers.setFeatures(QDockWidget.DockWidgetFloatable|QDockWidget.DockWidgetMovable)
        MainWindow.addDockWidget(Qt.DockWidgetArea.RightDockWidgetArea, self.registers)
        self.memoryView = MemoryView(MainWindow)
        self.memoryView.setObjectName(u"memoryView")
        self.memoryView.setFeatures(QDockWidget.DockWidgetFloatable|QDockWidget.DockWidgetMovable)
        ...
        self.menubar.addAction(self.Visibility.menuAction())
        ...
        self.Visibility.addAction(self.isRegisters)
        self.Visibility.addAction(self.isCode)
        self.Visibility.addAction(self.isMemory)
    ...
    def retranslateUi(self, MainWindow):
...
#endif // QT_CONFIG(shortcut)
        self.isAssembler.setText(QCoreApplication.translate("MainWindow", u"\u041e\u0442\u043b\u0430\u0434\u043a\u0430", None))
        self.isRegisters.setText(QCoreApplication.translate("MainWindow", u"\u0420\u0435\u0433\u0438\u0441\u0442\u0440\u044b", None))
        self.isCode.setText(QCoreApplication.translate("MainWindow", u"\u041a\u043e\u0434", None))
        ...
        self.Visibility.setTitle(QCoreApplication.translate("MainWindow", u"\u0412\u043a\u043b\u0430\u0434\u043a\u0438", None))
    # retranslateUi
